...
// function loadDataAndSetupForm() {
//   // Function to load user data and set up the form
//   fetch("http://localhost/api/user")
//       .then(response => response.json())
//       .then(data => {
//           console.log('API Response:', data);
...
// // function executeOnLoginFormChange() {
...
// //               // You can perform further actions based on the response, e.g., show a success message or redirect the user

// //               // If it's an update, you might want to reload the user data after a successful update
// //               if (isUpdate) {
// //                   loadDataAndSetupForm();
